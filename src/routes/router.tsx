...
export const router = createBrowserRouter([
  {
    // Rota raiz sem path: captura erros de qualquer tela (inclusive falha ao carregar chunks).
      ...
      { path: '/definir-senha', lazy: lazyRoute(() => import('@/pages/AcceptInvitePage'), 'AcceptInvitePage') },
      {
        ...
        children: [
          ...
          { path: '/ordens/:id/recibo', lazy: lazyRoute(() => import('@/pages/ReceiptPage'), 'ReceiptPage') },
          {
            ...
            children: [
              {
                // Erro dentro do painel: mostra a mensagem no conteúdo, mantendo a navegação lateral.
